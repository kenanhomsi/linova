...
const DentalHoliday = () => {
    ...
    const faqs = [
        { q: "What languages are spoken at the clinic?", a: "English, Arabic, Turkish, Russian — our coordinators ensure clear communication at every step." },
        { q: "Do I need a visa for Turkey?", a: "Many nationalities can obtain e‑Visa online. We provide guidance based on your passport." },
        { q: "What’s included in the all‑inclusive package?", a: "Treatment, luxury hotel, VIP airport transfers, clinic‑hotel shuttles, coordinator, and post‑care. Flight is separate." },
        { q: "Is Istanbul safe for medical tourists?", a: "Absolutely. Millions of tourists visit Istanbul safely each year. Our team assists with everything 24/7." },
        { q: "How far in advance should I book?", a: "We recommend 4–6 weeks ahead for ideal hotel availability and treatment planning." }
    ];
...
//   }
    ...
    const steps = [
  {
    ...
    title: "Virtual smile preview & treatment blueprint",
    desc: "Share your photos and concerns online. Our specialists create a 3D simulation of your future smile and a detailed timeline — all before you pack your bags.",
    list: ["Free video consultation with a dentist", "Digital smile design preview", "Transparent quote & treatment roadmap"],
    img: "https://images.pexels.com/photos/3845752/pexels-photo-3845752.jpeg?auto=compress&cs=tinysrgb&w=800&h=500&fit=crop"
  },
  {
    number: "02",
    title: "Private transfer & stay in Istanbul's finest districts",
    desc: "Forget taxi stress. Our VIP driver welcomes you at the airport and whisks you to a handpicked hotel in Nişantaşı, Beşiktaş, or Sultanahmet — where comfort meets culture.",
    list: ["Meet & greet at the arrivals gate", "Luxury or boutique hotel options", "Daily shuttles to the clinic"],
  ...
  },
  {
    ...
    title: "Advanced diagnostics & smile architect session",
    desc: "In-clinic CBCT scan, intraoral photography, and a face‑to‑face session with your lead dentist. We finalise every detail of your new smile using CAD/CAM technology.",
    list: ["Painless digital impressions", "Provisional mock‑up try‑on", "Material selection (zirconia, lithium disilicate)"],
    img: "https://images.pexels.com/photos/3845913/pexels-photo-3845913.jpeg?auto=compress&cs=tinysrgb&w=800&h=500&fit=crop"
  },
  {
    number: "04",
    title: "Between appointments: explore Istanbul like a local",
    desc: "Your treatment schedule leaves room for discovery. We suggest gentle activities: a Bosphorus ferry ride, the Spice Bazaar, or a traditional Turkish bath — all vetted for hygiene and comfort.",
    list: ["Bosphorus cruise with audio guide", "Hagia Sophia & Blue Mosque (short walk)", "Optional private hamam experience"],
    img: "https://images.pexels.com/photos/2795408/pexels-photo-2795408.jpeg?auto=compress&cs=tinysrgb&w=800&h=500&fit=crop"
  },
  {
    number: "05",
    title: "Precision placement & final smile reveal",
    desc: "Your permanent restorations are bonded with meticulous care. We check bite, aesthetics, and comfort. You'll leave the clinic with your dream smile — and a mirror selfie.",
    list: ["Final adjustments under magnification", "High‑quality ceramic or zirconia", "Same‑day aftercare instructions"],
    img: "https://images.pexels.com/photos/3845855/pexels-photo-3845855.jpeg?auto=compress&cs=tinysrgb&w=800&h=500&fit=crop"
  },
  {
    number: "06",
    title: "Remote aftercare & lifetime smile support",
    desc: "Your journey doesn't end at the airport. We schedule video check‑ups, send a custom care kit, and offer a warranty on all work. You're never alone with your new smile.",
    list: ["24/7 WhatsApp support line", "Free follow‑up consultation within 1 year", "Discount on future visits or maintenance"],
    img: "https://images.pexels.com/photos/4065881/pexels-photo-4065881.jpeg?auto=compress&cs=tinysrgb&w=800&h=500&fit=crop"
  }
];
    const packages = [
        { name: "3‑Day Quick Veneer", desc: "Porcelain veneers or composite bonding. Perfect for minor corrections.", price: "from €1,490", icon: "fas fa-calendar-week", badge: "popular" },
        { name: "5‑Day Hollywood Smile", desc: "Full smile makeover: 20+ zirconia crowns / veneers. Complete transformation.", price: "from €2,990", icon: "fas fa-star", badge: "best value" },
        { name: "7‑Day Treatment + Tourism", desc: "Comprehensive dental work + guided tours, Bosphorus dinner, and premium stay.", price: "from €3,790", icon: "fas fa-umbrella-beach", badge: "luxury" }
    ];
        ...
        <div className="font-sans bg-white text-[#1a2c3a]">
            ...
            <section className="py-12 md:py-20 bg-gradient-to-r from-[#fefcf7] to-white">
                <div className="container mx-auto px-5 md:px-10 flex flex-col md:flex-row items-center gap-12">
                    <motion.div className="flex-1" initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
                        <div className="inline-block bg-[#e9f4ef] px-4 py-1 rounded-full text-sm font-semibold text-[#1b8c5e] mb-5">✧ 5‑star dental holiday | Istanbul</div>
                        <h1 className="text-4xl md:text-5xl font-bold font-['Playfair_Display'] leading-tight text-[#0a2f28]">Your smile journey, wrapped in Bosphorus magic</h1>
                        <p className="text-lg text-[#3c5a6b] my-6 max-w-xl">World-class dental care combined with 5‑star hotels, VIP transfers, and curated Istanbul experiences — all tailored around your treatment plan.</p>
                        <div className="flex gap-4 flex-wrap">
                            <a href="#" className="bg-[#1b8c5e] text-white px-7 py-3 rounded-full font-semibold hover:bg-[#0f6b48] transition shadow">Start free consultation →</a>
                        ...
                        <div className="flex gap-8 mt-8">
                            <div><span className="text-2xl font-bold text-[#1b8c5e]">1,200+</span><p className="text-xs text-[#5f7f8c]">Happy patients</p></div>
                            <div><span className="text-2xl font-bold text-[#1b8c5e]">98%</span><p className="text-xs text-[#5f7f8c]">Success rate</p></div>
                            <div><span className="text-2xl font-bold text-[#1b8c5e]">5⭐</span><p className="text-xs text-[#5f7f8c]">Google reviews</p></div>
                        </div>
                    </motion.div>
                    <motion.div className="flex-1 bg-gradient-to-br from-[#eef7f2] to-[#e2f0ea] rounded-3xl p-6 text-center shadow-xl" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6 }}>
                        <i className="fas fa-tooth text-5xl text-[#1b8c5e] mb-4"></i>
                        <img src="https://images.unsplash.com/photo-1606811971618-4486d14f3f99?w=500&h=350&fit=crop" alt="Dental care" className="rounded-2xl w-full shadow-md" />
                    </motion.div>
                </div>
            </section>
...
<div className="container mx-auto px-5 md:px-10 py-20 relative">
              ...
              >
                <div className="relative rounded-2xl overflow-hidden shadow-2xl group">
                  ...
                  <div className="absolute bottom-5 left-5 z-20 flex items-center gap-2 bg-white/95 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg">
                    ...
                    <span className="text-sm font-bold text-[#1b8c5e]">Step {step.number}</span>
                  </div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="bg-[#e9f4ef] text-[#1b8c5e] text-xs px-3 py-1 rounded-full">Medical</span>
                    <span className="bg-[#e9f4ef] text-[#1b8c5e] text-xs px-3 py-1 rounded-full">Luxury</span>
                  </div>
                </div>
                ...
                <ul className="space-y-3 pt-2">
                  {step.list.map((item, i) => (
                    ...
                    >
                      ...
                      <span className="text-[#2f5668] group-hover:text-[#1c4035] transition">{item}</span>
                    </motion.li>
                  ))}
                </ul>
  ...
  <div className="text-center mt-16">
    ...
    >
      ...
      <span className="text-sm font-medium text-[#2f5668]">Start your journey today —</span>
      <a href="#" className="text-[#1b8c5e] font-semibold hover:underline">free consultation →</a>
    </motion.div>
  </div>
</div>
            {/* Packages */}
            <section className="bg-[#fafcf9] py-16">
                <div className="container mx-auto px-5 md:px-10">
                    <div className="text-center mb-10">
                        <h2 className="text-3xl md:text-4xl font-bold font-['Playfair_Display'] text-[#133b30]">All‑inclusive dental holiday packages</h2>
                        <p className="text-[#558395] max-w-xl mx-auto mt-2">Transparent pricing, luxury accommodation, VIP transfers — everything included.</p>
                    </div>
                    <div className="grid md:grid-cols-3 gap-8">
                        {packages.map((pkg, idx) => (
                            <motion.div key={idx} whileHover={{ y: -8 }} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: idx * 0.1 }} viewport={{ once: true }} className="bg-white rounded-3xl p-6 text-center border border-[#eef3ef] shadow-sm">
                                <i className={`${pkg.icon} text-4xl text-[#1b8c5e] mb-4`}></i>
                                <div className="inline-block bg-[#e5f2ec] px-3 py-1 rounded-full text-xs font-semibold mb-3">{pkg.badge}</div>
                                <h4 className="text-xl font-bold mb-2">{pkg.name}</h4>
                                <p className="text-sm text-[#5f7f8c] mb-4">{pkg.desc}</p>
                                <p className="text-2xl font-bold text-[#1b8c5e] mb-5">{pkg.price}</p>
                                <a href="#" className="border border-[#1b8c5e] text-[#1b8c5e] px-5 py-2 rounded-full text-sm font-semibold hover:bg-[#1b8c5e08] transition inline-block">Learn more →</a>
                            </motion.div>
                        ))}
                    </div>
                    <p className="text-center text-xs text-gray-500 mt-6">*Packages include: dental treatment, 5‑star hotel, airport transfers, coordinator support. Flight extra.</p>
                </div>
            </section>
                ...
                <div className="grid md:grid-cols-2 gap-10">
                    <FadeInWhenVisible>
                        <div className="bg-white p-8 rounded-3xl border border-[#eef3ef]">
                            ...
                            <h3 className="text-2xl font-bold mt-4 mb-2">Trusted expertise</h3>
                            <ul className="space-y-3 text-[#2f5668]">
                                <li className="flex items-center gap-3"><i className="fas fa-check-circle text-[#1b8c5e]"></i> ISO & CE certified clinic</li>
                                <li className="flex items-center gap-3"><i className="fas fa-language text-[#1b8c5e]"></i> English, Arabic, Turkish, Russian support</li>
                                <li className="flex items-center gap-3"><i className="fas fa-clock text-[#1b8c5e]"></i> No waiting lists — immediate planning</li>
                                <li className="flex items-center gap-3"><i className="fas fa-hand-holding-heart text-[#1b8c5e]"></i> 98% patient satisfaction rate</li>
                            </ul>
                        </div>
                    </FadeInWhenVisible>
                    <FadeInWhenVisible delay={0.2}>
                        <div className="bg-white p-8 rounded-3xl border border-[#eef3ef]">
                            ...
                            <h3 className="text-2xl font-bold mt-4 mb-2">Istanbul like a local</h3>
                            <ul className="space-y-3 text-[#2f5668]">
                                <li className="flex items-center gap-3"><i className="fas fa-ship text-[#1b8c5e]"></i> Bosphorus cruise (2‑3 hrs)</li>
                                <li className="flex items-center gap-3"><i className="fas fa-landmark text-[#1b8c5e]"></i> Hagia Sophia & Blue Mosque</li>
                                <li className="flex items-center gap-3"><i className="fas fa-store text-[#1b8c5e]"></i> Grand Bazaar / Spice Bazaar</li>
                                <li className="flex items-center gap-3"><i className="fas fa-hot-tub text-[#1b8c5e]"></i> Traditional Turkish hamam</li>
                            </ul>
                        </div>
                    </FadeInWhenVisible>
                </div>
