...
export function SeoContentSection({ locale }: SeoContentSectionProps) {
    ...
    return (
        <Box component="section" py={72} bg="#f8fafc" aria-labelledby="seo-content-title">
            <Container size="lg">
                <Stack gap="xl">
                    <Stack gap="sm" maw={840}>
                        ...
                        <Title id="seo-content-title" order={2} style={{ lineHeight: 1.15 }}>
                            Why patients search for Linova Clinic in Istanbul
                        </Title>
                        <Text size="lg" c="dimmed" style={{ lineHeight: 1.8 }}>
                            Linova Clinic is a modern dental clinic in Turkey focused on dental implants,
                            veneers, Hollywood Smile treatments, and complete smile restoration. Our team in
                            Istanbul combines digital dentistry, transparent planning, and a full dental tourism
                            journey for patients who want quality care and a smoother travel experience.
                        </Text>
                        <Text size="md" c="dimmed" style={{ lineHeight: 1.8 }}>
                            ...
                            and want a focused overview before choosing a provider, this landing page can help.
                        </Text>
                        <Text size="md" c="dimmed" style={{ lineHeight: 1.8 }}>
                            If you are comparing a{" "}
                    ...
                    <SimpleGrid cols={{ base: 1, md: 3 }} spacing="lg">
                        {pillars.map((pillar) => (
                            <Card key={pillar.title} radius="lg" shadow="sm" padding="xl" withBorder>
                                <Stack gap="sm">
